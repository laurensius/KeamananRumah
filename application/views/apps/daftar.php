            ...
            <div class="row bs-reset">
                ...
                <div class="col-md-6 login-container bs-reset mt-login-5-bsfix">
                    <div class="login-content">
                        <h1>Kemananan Rumah</h1>
                        <p>Isi form pendaftaran di bawah ini dengan benar.</p>
                        <form action="javascript:;" class="login-form" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12">
                                    <input class="form-control form-control-solid placeholder-no-fix form-group" type="text" autocomplete="off" placeholder="Nama Lengkap" name="nama" id="nama" required/> </div>
                                <div class="col-xs-12">
                                    <input class="form-control form-control-solid placeholder-no-fix form-group" type="text" autocomplete="off" placeholder="Alamat tempat tinggal" name="alamat" id="alamat" required/> </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-4">
                                </div>
                                <div class="col-sm-8 text-right">
                                    <div class="forgot-password">
                                        <a href="<?php echo site_url() ?>/keamananrumah/">Klik di sini untuk Login</a>
                                    </div>
                    ...
                    $.ajax({
                        ...
                        success : function(response){
                            if(response.response.status_cek === 'FAILED' || response.response.status_cek === 'FOUND' || response.response.status_cek === 'NO DATA POSTED'){
                                ...
                                window.location = "<?php echo site_url(); ?>/keamananrumah/";
                            }
                        },
