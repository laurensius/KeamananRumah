...
<!--                     <img class="login-logo" src="<?php echo base_url();?>assets/pages/img/login/home_secure.png" /> -->
                    </div>
                </div>
                <div class="col-md-6 login-container bs-reset mt-login-5-bsfix">
                    <div class="login-content">
                        <h1>Kemananan Rumah</h1>
                        <p> Untuk menggunakan fitur Keamanan Rumah, silahkan isi form di bawah ini untuk melakukan login. Terima kasih </p>
        ...
        function cek(){
            ...
            var notif = '';
            if(input_u == "" || input_u == null || input_p == "" || input_p == null){
                notif += '<div class="alert alert-warning alert-dismissable">';
                notif += 'Masukkan Username dan Password'
                notif += '</div>';
                ...
                $.ajax({
                    ...
                    success : function(response){
                        if(response.response.status_cek === 'NOT MATCH' || response.response.status_cek === 'NOT FOUND'){
